...
function CommentItem({comment, initiateReply, removeFromCommentList, user} : {comment: CommentData, initiateReply : InitiateReplyFunction, removeFromCommentList : RemoveFromCommentList, user : {id?: string} | null}) {
